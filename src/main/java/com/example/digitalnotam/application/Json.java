...
final class Json {
    ...
    private static String atsaNew(AtsaNewData value){AtsaNewData v=value==null?AtsaNewData.empty():value;return "{"+field("type",v.type())+","+field("classification",v.classification())+","+field("designator",v.designator())+","+field("name",v.name())+","+field("activationStatus",v.activationStatus())+","+field("locationNote",v.locationNote())+","+field("geometryJson",v.geometryJson())+","+field("lowerValue",v.lowerValue())+","+field("lowerUom",v.lowerUom())+","+field("lowerReference",v.lowerReference())+","+field("upperValue",v.upperValue())+","+field("upperUom",v.upperUom())+","+field("upperReference",v.upperReference())+","+field("controllingUnitNote",v.controllingUnitNote())+","+field("note",v.note())+","+field("excludedAirspaces",v.excludedAirspaces())+","+field("nearbyAirportThresholdNm",v.nearbyAirportThresholdNm())+"}";}
