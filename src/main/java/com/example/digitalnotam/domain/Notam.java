...
public record Notam(
        ...
        NavUnsData navUnsData, ScheduleData scheduleData,
        AtsaNewData atsaNewData) {
    ...
    public Notam(String id,String number,String scenario,String title,String airport,String featureType,
        ...
        this(id,number,scenario,title,airport,featureType,condition,selectedRunways,selectedTaxiways,eventDescription,reason,remarks,
                ...
                pprValue,pprUnit,pprDetails,adLimRestrictions,rwyTargetType,runwayUuid,runwayDirectionUuid,"","","","","",NavUnsData.empty(),ScheduleData.empty(),AtsaNewData.empty());
    }
    ...
    public Notam(String id, String number, String scenario, String title, String airport, String featureType,
        ...
        this(id, number, scenario, title, airport, featureType, condition, selectedRunways, selectedTaxiways,
                ...
                "", "", "", "", "", "",
                "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", List.of(),"","","",
                "","","","","",NavUnsData.empty(),ScheduleData.empty(),AtsaNewData.empty());
    }
    ...
    public Notam publish() {
        return new Notam(id, number, scenario, title, airport, featureType, condition, selectedRunways, selectedTaxiways, eventDescription, reason, remarks,
                ...
                airspaceGroupId,selectedAirspaces,activationStatus,affectedAirports,additionalFirs,navUnsData,scheduleData,atsaNewData);
    }
    ...
    public Notam withAtsaAct(String group,String airspaces,String activation,String airports,String firs){return new Notam(id,number,scenario,title,airport,featureType,condition,selectedRunways,selectedTaxiways,eventDescription,reason,remarks,effectiveStart,effectiveEnd,latitude,longitude,radiusNm,latitudeHemisphere,longitudeHemisphere,qCode,traffic,purpose,scope,lowerMeters,upperMeters,scheduleMode,scheduleDay,scheduleStart,scheduleEnd,status,createdAt,publishedAt,fir,scheduleStartDate,scheduleEndDate,qOverrideReason,qOverrideOperator,qOverrideAt,limitationType,operation,flightType,flightRule,flightStatus,flightMilitary,flightOrigin,flightPurpose,aircraftType,aircraftEngine,aircraftWingSpan,aircraftWingSpanUom,aircraftWingSpanInterpretation,aircraftWeight,aircraftWeightUom,aircraftWeightInterpretation,pprValue,pprUnit,pprDetails,adLimRestrictions,rwyTargetType,runwayUuid,runwayDirectionUuid,group,airspaces,activation,airports,firs,navUnsData,scheduleData,atsaNewData);}
    public Notam withNavUns(NavUnsData value){return new Notam(id,number,scenario,title,airport,featureType,condition,selectedRunways,selectedTaxiways,eventDescription,reason,remarks,effectiveStart,effectiveEnd,latitude,longitude,radiusNm,latitudeHemisphere,longitudeHemisphere,qCode,traffic,purpose,scope,lowerMeters,upperMeters,scheduleMode,scheduleDay,scheduleStart,scheduleEnd,status,createdAt,publishedAt,fir,scheduleStartDate,scheduleEndDate,qOverrideReason,qOverrideOperator,qOverrideAt,limitationType,operation,flightType,flightRule,flightStatus,flightMilitary,flightOrigin,flightPurpose,aircraftType,aircraftEngine,aircraftWingSpan,aircraftWingSpanUom,aircraftWingSpanInterpretation,aircraftWeight,aircraftWeightUom,aircraftWeightInterpretation,pprValue,pprUnit,pprDetails,adLimRestrictions,rwyTargetType,runwayUuid,runwayDirectionUuid,airspaceGroupId,selectedAirspaces,activationStatus,affectedAirports,additionalFirs,value,scheduleData,atsaNewData);}
    public Notam withScheduleData(ScheduleData value){return new Notam(id,number,scenario,title,airport,featureType,condition,selectedRunways,selectedTaxiways,eventDescription,reason,remarks,effectiveStart,effectiveEnd,latitude,longitude,radiusNm,latitudeHemisphere,longitudeHemisphere,qCode,traffic,purpose,scope,lowerMeters,upperMeters,scheduleMode,scheduleDay,scheduleStart,scheduleEnd,status,createdAt,publishedAt,fir,scheduleStartDate,scheduleEndDate,qOverrideReason,qOverrideOperator,qOverrideAt,limitationType,operation,flightType,flightRule,flightStatus,flightMilitary,flightOrigin,flightPurpose,aircraftType,aircraftEngine,aircraftWingSpan,aircraftWingSpanUom,aircraftWingSpanInterpretation,aircraftWeight,aircraftWeightUom,aircraftWeightInterpretation,pprValue,pprUnit,pprDetails,adLimRestrictions,rwyTargetType,runwayUuid,runwayDirectionUuid,airspaceGroupId,selectedAirspaces,activationStatus,affectedAirports,additionalFirs,navUnsData,value,atsaNewData);}
    public Notam withAtsaNew(AtsaNewData value){return new Notam(id,number,scenario,title,airport,featureType,condition,selectedRunways,selectedTaxiways,eventDescription,reason,remarks,effectiveStart,effectiveEnd,latitude,longitude,radiusNm,latitudeHemisphere,longitudeHemisphere,qCode,traffic,purpose,scope,lowerMeters,upperMeters,scheduleMode,scheduleDay,scheduleStart,scheduleEnd,status,createdAt,publishedAt,fir,scheduleStartDate,scheduleEndDate,qOverrideReason,qOverrideOperator,qOverrideAt,limitationType,operation,flightType,flightRule,flightStatus,flightMilitary,flightOrigin,flightPurpose,aircraftType,aircraftEngine,aircraftWingSpan,aircraftWingSpanUom,aircraftWingSpanInterpretation,aircraftWeight,aircraftWeightUom,aircraftWeightInterpretation,pprValue,pprUnit,pprDetails,adLimRestrictions,rwyTargetType,runwayUuid,runwayDirectionUuid,airspaceGroupId,selectedAirspaces,activationStatus,affectedAirports,additionalFirs,navUnsData,scheduleData,value);}
}
